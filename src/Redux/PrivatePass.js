...
export const PrivatePass = createSlice({

    name: "private",
    initialState,
    reducers: {
        handlePrivaeData: (state, action) => {
        ...
        handlePrivaeDataClear: (state, action) => {
...
export const { handlePrivaeData, handlePrivaeDataClear } = PrivatePass.actions;

export default PrivatePass.reducer;